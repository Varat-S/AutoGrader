...
class ShotSemanticAnalysis(BaseModel):
    ...
    likely_neutral_objects: List[str] = Field(default_factory=list, description="Objects in frame likely to be neutral white/gray (walls, shirts, pavement)")
...
class CinematographyResearchResult(BaseModel):
    ...
    synthesized_principles: List[str] = Field(default_factory=list, description="Core cinematography and lighting principles extracted from sources")
